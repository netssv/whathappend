...
| `stack` | Fingerprints the technology stack (frameworks, server). | `tech`, `wappalyzer` |
| `cms` | Detects the Content Management System (WordPress, Shopify, etc.). | `wordpress` |
| `rank` | Global domain traffic ranking estimation. | `traffic`, `ranking` |
