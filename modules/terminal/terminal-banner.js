...
export function showBanner(term) {
    ...
    if (cols >= 60) {
        // WIDE SCREEN
        term.writeln(`  \x1b[1m\x1b[36mWhatHappened\x1b[0m \x1b[33mv${version}\x1b[0m \x1b[90m│\x1b[0m Platform Navigator`);
        ...
        // MEDIUM SCREEN
        term.writeln(`  \x1b[1m\x1b[36mWhatHappened\x1b[0m \x1b[33mv${version}\x1b[0m`);
