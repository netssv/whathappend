...
export async function cmdOg(args) {
    ...
    try {
        ...
        if (!isLive) {
            ...
            ins.push({level: "INFO", text: "To scan the final DOM, navigate to the site in your browser and run: og here"});
        }

        ins.push({level: "INFO", text: `External Check: https://opengraph.xyz/url/https://${domain}`});
