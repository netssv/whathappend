...
export function cmdDetailedHelp(cmd, suggestCommand) {
    ...
    const h = {
        ...
        dkim:()=>formatHelp({name:"dkim", syntax:"[domain]", descLines:["DKIM signature scan.", "Checks 76 common selectors to find which", "providers (Mailchimp, Google) sign emails here."], aliases:null, examples:[{cmd: "dkim google.com"}]}),
