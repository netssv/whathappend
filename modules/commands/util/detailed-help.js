...
export function cmdDetailedHelp(cmd, suggestCommand) {
    ...
    const h = {
        ...
        watch:()=>formatHelp({name:"watch", syntax:"[raw|dashboard]", descLines:["Live network activity monitor.", "Default: graphical waterfall with timing bars.", "'watch raw': streaming log of full URLs as they load.", "'watch dashboard': aggregated metrics (heap, DOM, page weight, assets by type)."], aliases:"monitor, waterfall, live, netwatch", examples:[{cmd: "watch", desc: "graphical waterfall"}, {cmd: "watch raw", desc: "raw request stream"}, {cmd: "watch dashboard", desc: "aggregated metrics"}]}),
