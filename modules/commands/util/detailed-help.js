...
export function cmdDetailedHelp(cmd, suggestCommand) {
    ...
    const h = {
        ...
        hack:()=>formatHelp({name:"hack", syntax:"", descLines:["Technical trivia simulation.", "A 10-question multiple-choice quiz covering", "DNS records, SEO best practices, and Web Security.", "Presents an interactive UI with instant feedback."], aliases:"trivia, quiz", examples:[{cmd: "hack"}, {cmd: "trivia"}]}),
